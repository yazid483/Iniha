...
# --- Configuration ---
TOKEN = 'توكنك هنا' # Replace with your actual token
OWNER_ID = ايديك # Replace with your Owner ID
ADMIN_ID = ايديك # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = 'يوزرك' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'يوزر قناتك' # Replace with your update channel link
